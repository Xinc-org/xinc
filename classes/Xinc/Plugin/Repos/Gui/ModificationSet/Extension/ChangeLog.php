...
class Xinc_Plugin_Repos_Gui_ModificationSet_Extension_ChangeLog extends Xinc_Plugin_Repos_Gui_Dashboard_Detail_Extension
{
    ...
    public function getContent(Xinc_Build_Interface &$build)
    {
        ...
        if ($changeSet instanceof Xinc_Plugin_Repos_ModificationSet_Result ) {
            ...
            $logMessageTemplateFile = Xinc_Data_Repository::getInstance()->get('templates' . DIRECTORY_SEPARATOR 
