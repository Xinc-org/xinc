...
*/
class Xinc_Plugin_Repos_Gui_Menu_Item
{
    ...
    public function __construct($id, $text, $singleClickExpand=true,
                                $url=null, $iconCls=null, $title='',
                                $scripts=false, $leaf=true, $frame=false,
                                $height='auto', $children=array())
    {
        $this->_id = $id;
        $this->_text = $text;
