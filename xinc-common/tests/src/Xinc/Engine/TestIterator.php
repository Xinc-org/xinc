<?php
/**
 * Test Class for the Xinc Engine Iterator
 * 
 * @package Xinc.Engine
...
class Xinc_Engine_TestIterator extends Xinc_BaseTest
{
    ...
    public function testValid()
    {
        ...
        $arr = array();
        $element = new Xinc_Engine_Sunrise();
        $arr[] = $element;
        try {
            $iterator = new Xinc_Engine_Iterator($arr);
        ...
        } catch (Xinc_Engine_Exception_Invalid $invalid) {
